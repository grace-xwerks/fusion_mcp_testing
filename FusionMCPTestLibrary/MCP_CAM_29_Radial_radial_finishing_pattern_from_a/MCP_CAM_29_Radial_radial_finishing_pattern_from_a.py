"""
MCP_CAM_29_Radial_radial_finishing_pattern_from_a
=================================================
Group       : Manufacture
Script ID   : CAM-29
Description : Radial (radial finishing pattern from a center point)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_29_Radial_radial_finishing_pattern_from_a
