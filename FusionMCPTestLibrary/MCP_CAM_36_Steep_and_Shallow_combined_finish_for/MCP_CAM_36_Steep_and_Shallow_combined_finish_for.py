"""
MCP_CAM_36_Steep_and_Shallow_combined_finish_for
================================================
Group       : Manufacture
Script ID   : CAM-36
Description : Steep and Shallow (combined finish for steep walls + shallow faces)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_36_Steep_and_Shallow_combined_finish_for
