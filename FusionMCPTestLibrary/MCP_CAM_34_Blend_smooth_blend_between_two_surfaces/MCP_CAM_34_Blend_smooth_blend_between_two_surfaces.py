"""
MCP_CAM_34_Blend_smooth_blend_between_two_surfaces
==================================================
Group       : Manufacture
Script ID   : CAM-34
Description : Blend (smooth blend between two surfaces — 5-axis common pattern)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_34_Blend_smooth_blend_between_two_surfaces
