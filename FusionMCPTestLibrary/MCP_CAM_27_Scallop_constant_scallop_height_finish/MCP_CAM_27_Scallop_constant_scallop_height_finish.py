"""
MCP_CAM_27_Scallop_constant_scallop_height_finish
=================================================
Group       : Manufacture
Script ID   : CAM-27
Description : Scallop (constant-scallop-height finish — uniform surface finish)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_27_Scallop_constant_scallop_height_finish
