"""
MCP_CAM_22_3D_Adaptive_Clearing_HEM_style_rough_of
==================================================
Group       : Manufacture
Script ID   : CAM-22
Description : 3D Adaptive Clearing (HEM-style rough of the full Bracket model)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_22_3D_Adaptive_Clearing_HEM_style_rough_of
