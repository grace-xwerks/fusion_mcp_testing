"""
MCP_CAM_37_Morph_API_surface_demo_needs_two_guide
=================================================
Group       : Manufacture
Script ID   : CAM-37
Description : Morph — API-surface demo (needs two guide curves)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_37_Morph_API_surface_demo_needs_two_guide
