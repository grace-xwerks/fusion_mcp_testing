"""
MCP_CAM_32_Flat_finishes_the_flat_bottomed_planar
=================================================
Group       : Manufacture
Script ID   : CAM-32
Description : Flat (finishes the flat-bottomed planar regions)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_32_Flat_finishes_the_flat_bottomed_planar
