"""
MCP_CAM_23_Pocket_Clearing_3D_pocket_rough_non
==============================================
Group       : Manufacture
Script ID   : CAM-23
Description : Pocket Clearing (3D pocket rough — non-adaptive alternative)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_23_Pocket_Clearing_3D_pocket_rough_non
