"""
MCP_CAM_38_Project_API_surface_demo_needs_source
================================================
Group       : Manufacture
Script ID   : CAM-38
Description : Project — API-surface demo (needs source curves to project)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_38_Project_API_surface_demo_needs_source
