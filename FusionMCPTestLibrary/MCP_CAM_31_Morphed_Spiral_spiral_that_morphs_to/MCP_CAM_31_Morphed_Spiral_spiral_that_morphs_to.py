"""
MCP_CAM_31_Morphed_Spiral_spiral_that_morphs_to
===============================================
Group       : Manufacture
Script ID   : CAM-31
Description : Morphed Spiral (spiral that morphs to match boundary shape)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_31_Morphed_Spiral_spiral_that_morphs_to
