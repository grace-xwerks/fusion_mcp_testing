"""
MCP_CAM_30_Spiral_spiral_finishing_from_a_center
================================================
Group       : Manufacture
Script ID   : CAM-30
Description : Spiral (spiral finishing from a center point outward)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_30_Spiral_spiral_finishing_from_a_center
