"""
MCP_CAM_26_Contour_3D_constant_Z_finish_wedding
===============================================
Group       : Manufacture
Script ID   : CAM-26
Description : Contour 3D (constant-Z finish — wedding-cake terrace pattern)
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_26_Contour_3D_constant_Z_finish_wedding
