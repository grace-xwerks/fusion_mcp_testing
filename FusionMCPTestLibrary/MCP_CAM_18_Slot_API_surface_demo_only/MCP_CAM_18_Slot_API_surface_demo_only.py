"""
MCP_CAM_18_Slot_API_surface_demo_only
=====================================
Group       : Manufacture
Script ID   : CAM-18
Description : Slot — API-surface demo only
Generated   : 2026-05-19

Part of the Fusion MCP Test Library.
Run via: Fusion → Tools → Scripts and Add-Ins → Scripts tab → MCP_CAM_18_Slot_API_surface_demo_only
